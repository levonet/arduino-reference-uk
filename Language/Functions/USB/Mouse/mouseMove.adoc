...
[float]
=== Параметри
`xVal`: amount to move along the x-axis. Очікує тип даних: `signed char`. +
`yVal`: amount to move along the y-axis. Очікує тип даних: `signed char`. +
`wheel`: amount to move scroll wheel. Очікує тип даних: `signed char`.
